...
function wpcf7_email_author($tag) {
...
function cltv_wpcf7_add_shortcode() {
	//wpcf7_add_shortcode('author_email', 'wpcf7_email_author', true);
} 
add_action( 'init', 'cltv_wpcf7_add_shortcode' );
