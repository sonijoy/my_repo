...
<div id="tribe-events-content" class="upcoming">
	...
	<?php if(!tribe_is_day()): // day view doesn't have a grid ?>
		...
		<span class='tribe-events-calendar-buttons'> 
			<a class='tribe-events-button-on' href='<?php echo tribe_get_listview_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>'><?php _e('Event List', 'tribe-events-calendar'); ?></a>
			<a class='tribe-events-button-off' href='<?php echo tribe_get_gridview_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>'><?php _e('Calendar', 'tribe-events-calendar'); ?></a>
		</span>
