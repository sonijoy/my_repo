...
class acf_Wistia extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'wistia';
		$this->label = __("Wistia Widget",'acf');
	...
	*/
	...
	function create_field( $field )
	{
        ...
        <div id="wistia-upload-widget" style="width: 100px; height: 50px;"></div>
        <script src="http://static.wistia.com/javascripts/upload_widget.js"></script>
        <script>
        var widget1 = new wistia.UploadWidget({ divId: 'wistia-upload-widget', publicProjectId: '58nhqwtnv7' });
        </script>
