		...
		<div id='tribe-events-calendar-header' class="clearfix">
			<span class='tribe-events-month-nav'>
				<span class='tribe-events-prev-month'>
					<a href='<?php echo tribe_get_previous_month_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>' class="tribe-pjax">
					&#x2190; <?php echo tribe_get_previous_month_text(); ?>
					</a>
				</span>

				<?php //tribe_month_year_dropdowns( "tribe-events-" ); ?>
				<strong><?php echo tribe_get_displayed_month(); ?></strong>

				<span class='tribe-events-next-month'>
					<a href='<?php echo tribe_get_next_month_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>' class="tribe-pjax">
			...
			<span class='tribe-events-calendar-buttons'>
				<a class='tribe-events-button-off' href='<?php echo tribe_get_listview_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>'><?php _e('Event List', 'tribe-events-calendar'); ?></a>
				<a class='tribe-events-button-on' href='<?php echo tribe_get_gridview_link(); ?>?author_id=<?php echo $_GET['author_id']; ?>'><?php _e('Calendar', 'tribe-events-calendar'); ?></a>
			</span>
